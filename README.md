...
<!-- ANIMATED TITLE -->
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=24&pause=1000&color=00F7FF&center=true&vCenter=true&width=750&lines=🧠+NLP+Researcher+%7C+SOTA+86.4%25+F1-Score;⚡+LLM+Engineer+%7C+LoRA+Fine-Tuning+%26+Prompt+Engineering;👁️+Computer+Vision+%7C+YOLOv12+%2B+DeepSORT;🛡️+AI+Security+%7C+CipherCloud+IAM+Analyzer;🚀+Building+AI+for+Real-World+Impact" alt="Typing SVG" />
...
<details>
<summary><b>🧠 Code-Switched Arabic-English NER — Bachelor Thesis (SOTA Research)</b></summary>
<br/>

> Achieved **State-of-the-Art 86.4% F1-score** on Arabic-English mixed-script Named Entity Recognition — surpassing CAMELBERT (79.2%) and Ensemble methods (81.7%).

**Key Engineering Contributions:**
- Designed a novel **3-phase training pipeline**: Targeted Data Augmentation → Intermediate Pre-training → Supervised Contrastive Loss
...
<details>
<summary><b>🛡️ CipherCloud — AI-Powered AWS IAM Policy Analyzer</b></summary>
<br/>
...
<details>
<summary><b>👁️ Real-Time Traffic Sign Detection — YOLOv12 + DeepSORT</b></summary>
<br/>
...
<details>
<summary><b>📊 NoSQL Retail Data Analysis — MongoDB & Cassandra</b></summary>
<br/>
...
🎓 B.Sc. Data Science | Minor: Software Engineering *(Aug 2022 – Aug 2026)*

Relevant Coursework: Database Systems Design · Statistical Analysis · Cloud Computing (AWS) · Data Structures · Software Architecture · Calculus I & II · Project Management
